...
public class CurioFireResistanceEffect implements ICurioItem {
    ...
    public static void init() {
        final IStatGetter effectStatGetter = new StatGetterEffectLevel(flameProtectionEffect, 1);
        final GuiStatBar effectBar = new GuiStatBar
                (0, 0, barLength, flameProtectionName, 0, 30, false, effectStatGetter,
                        LabelGetterBasic.integerLabel, new TooltipGetterInteger
                        (flameProtectionTooltip, effectStatGetter));
