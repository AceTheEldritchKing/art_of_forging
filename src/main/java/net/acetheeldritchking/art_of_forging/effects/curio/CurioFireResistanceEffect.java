...
public class CurioFireResistanceEffect implements ICurioItem {
    ...
    public static void init() {
        var statGetter = new StatGetterEffectLevel(flameProtectionEffect, 1);
        GuiStatBar statBar = new GuiStatBar(0, 0, StatsHelper.barLength,
                flameProtectionName, 0, 10, false, false, false,
                statGetter, LabelGetterBasic.integerLabel,
                new TooltipGetterInteger(flameProtectionTooltip, statGetter)
        );
