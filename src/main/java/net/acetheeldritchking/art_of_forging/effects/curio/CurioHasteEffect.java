...
public class CurioHasteEffect implements ICurioItem {
    ...
    public static void init() {
        var statGetter = new StatGetterEffectLevel(hasteInfusedEffect, 1);
        GuiStatBar statBar = new GuiStatBar(0, 0, StatsHelper.barLength,
                hasteInfusedName, 0, 10, false, false, false,
                statGetter, LabelGetterBasic.integerLabel,
                new TooltipGetterInteger(hasteInfusedTooltip, statGetter)
        );
