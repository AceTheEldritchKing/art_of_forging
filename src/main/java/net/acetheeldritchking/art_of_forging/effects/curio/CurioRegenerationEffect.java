...
public class CurioRegenerationEffect implements ICurioItem {
    ...
    public static void init() {
        var statGetter = new StatGetterEffectLevel(healingInfusedEffect, 1);
        GuiStatBar statBar = new GuiStatBar(0, 0, StatsHelper.barLength,
                healingInfusedName, 0, 10, false, false, false,
                statGetter, LabelGetterBasic.integerLabel,
                new TooltipGetterInteger(healingInfusedTooltip, statGetter)
        );
        ...
        CuriosApi.getCuriosInventory(player).ifPresent(inv -> inv.findCurios
                ...
                slotResult -> {
                    ...
                    if (event.player.tickCount % 20 == 0) {
                        ...
                        // Effect potency
                        int level = item.getEffectLevel(itemStack, healingInfusedEffect);
